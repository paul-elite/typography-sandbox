      ...
      {previewMode === 'custom' && (
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full h-24 px-3 py-2 bg-white border border-zinc-300 rounded-lg text-sm text-zinc-900 placeholder-zinc-400 resize-none outline-none focus:border-blue-500 focus:shadow-[0_0_0_0.5px_#3b82f6]"
          />
        </div>
      )}
